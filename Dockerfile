...
RUN chmod 755 /usr/bin/entrypoint.sh && \
    ...
    apt-get update -q && \
    apt-get install -qy --no-install-recommends curl ca-certificates libgomp1 git unzip unrar p7zip-full python3-dev python3-pip p7zip-full build-essential automake && \
